...
def bioBERT_answer(user_input):
    medical_context = """
    Here are some general treatments for fever:
    ...
    If the fever persists for more than a few days or exceeds 103°F (39.4°C), it's best to seek medical attention.
    """
    ...
    # Get the top prediction and format the answer
    top_prediction = predictions[0]['sequence']
    return f"BioBERT Answer: {top_prediction}. Suggested treatment: {medical_context}"
